...
describe('Pantry', function() {
  ...
  beforeEach(function() {
    // creates object instances of ingredients to put in pantry
  ...
  it('should determine the amount of ingredients still needed to cook a given meal', () => {
    ...
    expect(pantry0.findIngredientsNeeded(recipe6)).to.deep.equal([{id: 14412, amount: 1}, {id: 20090, amount: 5}])
  })
